...
The airframe contains all the actuators, processors and batteries needed for flight.
...
\subsection{Dynamic Beheavior} \todo{put this subchapter into introduction}
...
A project that looks very suitable for the FINken is decaWave. \cite{uwb_decawave} claims that an accuracy of \SI{10}{\centi\metre} can be achieved and the nodes are aviable for purchase at reasonable prices. \todo{begründen warum wir das nicht benutzen}
\cite{uwb_localisation_copter} \todo{wiederspruch mit den 10cm, more like 50cm}
