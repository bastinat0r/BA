...
The area of operation for the FINken robots is only \SI{3}{m} by \SI{4}{m} so the range measurements need to be pretty accurate in this scenario. \todo{provide metric for hypothesis}
...
The price is justified by the superior performance of this method. \todo{price}
