...
Those robots shall perform given tasks defined to encurage swarm based interaction, that can be evaluated and compared to the theoretical models taken from swarm intelligence research.
...
\todo{list -> table of hardware components}
